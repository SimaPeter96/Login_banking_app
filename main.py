...
class Login:
    def __init__(self, root):
        ...
        # Background Image
        self.bg = ImageTk.PhotoImage(file=".idea/images/logo2.png")
        ...
        subtitle = Label(Frame_login, text="User login details", font=("Goudy old style", 15, "bold"), fg="#6162FF", bg="white").place(x=90, y=100)

        # Username
        lbl_user = Label(Frame_login, text="Username", font=("Goudy old style", 15, "bold"), fg="#6162FF", bg="white").place(x=90, y=140)
        self.username = Entry(Frame_login, font=("Goudy old style", 15), bg="#E7E6E6")
        self.username.place(x=90, y=170, width=320, height=35)

        # Password
        lbl_password = Label(Frame_login, text="Password", font=("Goudy old style", 15, "bold"), fg="#6162FF", bg="white").place(x=90, y=210)
    ...
    def check_function(self):
        ...
        elif self.username.get() != "Sima Peter" or self.password.get() != "CapaCiti2023":
